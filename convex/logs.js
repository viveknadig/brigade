...
const Level = v.union(v.literal("trace"), v.literal("debug"), v.literal("info"), v.literal("warn"), v.literal("error"), v.literal("fatal"));
// ============================================================================
...
export const readSubsystemRecords = query({
    ...
    handler: async (ctx, args) => {
        ...
        if (args.subsystem)
            rows = rows.filter((r) => r.subsystem === args.subsystem);
...
export const writeConfigHealth = mutation({
    ...
    handler: async (ctx, args) => {
        ...
        if (existing)
            ...
            await ctx.db.insert("configHealth", args);
    },
});
