...
export default defineSchema({
    ...
    personaFiles: defineTable({
        agentId: v.string(),
        name: v.union(v.literal("AGENTS.md"), v.literal("SOUL.md"), v.literal("IDENTITY.md"), v.literal("USER.md"), v.literal("TOOLS.md"), v.literal("BOOTSTRAP.md"), v.literal("MEMORY.md"), v.literal("HEARTBEAT.md")),
        content: Enc(),
        updatedAt: v.number(),
    })
    ...
    memoryFacts: defineTable({
        ...
        memoryId: v.string(),
        content: Enc(),
        segment: v.union(v.literal("identity"), v.literal("preference"), v.literal("correction"), v.literal("relationship"), v.literal("project"), v.literal("knowledge"), v.literal("context")),
    ...
    channelAccess: defineTable({
        ...
        channelId: v.string(),
        accountId: v.string(),
        kind: v.union(v.literal("allow-from"), v.literal("group-allow-from"), v.literal("pairing")),
        senderId: Enc(),
    ...
    authProfiles: defineTable({
        ...
        type: v.union(v.literal("api_key"), v.literal("oauth"), v.literal("token")),
        keyEnc: v.optional(Enc()),
        keyRef: v.optional(v.object({ source: v.string(), provider: v.string(), id: v.string() })),
        tokenEnc: v.optional(Enc()),
        tokenRef: v.optional(v.object({ source: v.string(), provider: v.string(), id: v.string() })),
    ...
    skills: defineTable({
        ownerId: v.string(),
        source: v.union(v.literal("bundled"), v.literal("config"), v.literal("managed"), v.literal("personal"), v.literal("project"), v.literal("workspace")),
    ...
    orgDeriveAudit: defineTable({
        ts: v.string(),
        topOrder: v.string(),
        mode: v.union(v.literal("derived"), v.literal("explicit"), v.literal("open")),
        edgeCount: v.number(),
    ...
    subagentRuns: defineTable({
        ...
        outcome: v.optional(v.object({
            status: v.union(v.literal("ok"), v.literal("error"), v.literal("timeout"), v.literal("abort")),
            text: v.optional(Enc()),
            error: v.optional(v.string()),
        ...
        suppressAnnounceReason: v.optional(v.union(v.literal("steer-restart"), v.literal("killed"))),
