...
const ProfileType = v.union(v.literal("api_key"), v.literal("oauth"), v.literal("token"));
...
export const listProfiles = query({
    ...
    handler: async (ctx, args) => {
        return ctx.db
            .query("authProfiles")
            .withIndex("by_owner_agent", (q) => q.eq("ownerId", args.ownerId).eq("agentId", args.agentId))
            .collect();
    },
});
export const getProfile = query({
    ...
    handler: async (ctx, args) => {
        return ctx.db
            .query("authProfiles")
            .withIndex("by_owner_agent_profileId", (q) => q
...
export const loadState = query({
    ...
    handler: async (ctx, args) => {
        return ctx.db
            .query("profileState")
            .withIndex("by_owner_agent_profileId", (q) => q.eq("ownerId", args.ownerId).eq("agentId", args.agentId))
            .collect();
    },
});
